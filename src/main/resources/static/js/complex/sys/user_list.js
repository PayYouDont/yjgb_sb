$(document).ready(function () {
    $('#mainTab').datagrid({
        ...
        idField: 'id',
        frozenColumns: [[{field: 'id', title: '用户id', width: 150, checkbox: true}, {
            field: 'name',
            title: '用户名',
            width: 150,
            align: 'center'
        }, {field: 'phone', title: '联系方式', width: 150, align: 'center'}, {
            field: 'roleGroupInfoName',
            title: '角色',
            width: 150,
            align: 'center'
        }, {field: 'areaCodeName', title: '管理区域', width: 150, align: 'center', sortable: true}]],
        columns: [[{field: 'areaCode', title: '管理区域编码', width: 150, align: 'center', sortable: true}, {
            field: 'sex',
            title: '性别',
            width: 150,
            align: 'center',
...
function doSearch(value) {
    $('#mainTab').datagrid('load', {userName: value});
}/*关闭模态框*/
