...
$.extend(groupview, {
	...
	insertRow: function(target, index, row,addGroupNum){
		var state = $.data(target, 'datagrid');
		var opts = state.options;
		var dc = state.dc;
		var group = null;
		var groupIndex;
		this.groups = groupview.groups;
		...
		if (group){
			if (index == undefined || index == null){
				...
				index = group.startIndex + group.rows.length+addGroupNum;
			}
